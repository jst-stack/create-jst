...
The wizard derives application metadata from the project directory, so it only asks about choices that change the generated project: package manager, dependency installation, and Git initialization.
